...
import { showDetailSelector, showEntitiesSelector } from "../selector";
          ...
          <div>
            <div className=" flex items-center justify-between pb-7">
              ...
              <div className="flex flex-col text-center pr-5">
                <h1 className="font-semibold text-gray-600 text-lg">Rating </h1>
...
const mapStateToProps = (s: State, props: any) => ({
  showDetail:
    showEntitiesSelector(s)[props.params.id] || showDetailSelector(s)[0],
});
